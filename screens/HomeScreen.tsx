...
const HomeScreen: React.FC<HomeScreenProps> = ({ reports, userName }) => {
  ...
  return (
    <div className="flex-1 overflow-y-auto px-6 pt-12 pb-24">
      <header className="mb-10 flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-slate-800">Hello, {userName || 'Citizen'}</h2>
          <p className="text-slate-500 text-sm">Report damage for a safer city.</p>
        </div>
