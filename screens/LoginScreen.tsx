          ...
          {step === 'info' ? (
            ...
            <div className="animate-in fade-in slide-in-from-right-4 duration-500 flex flex-col h-full">
              ...
              <p className="text-slate-500 text-sm mb-8 leading-relaxed">
                Enter the 4-digit code sent to <span className="text-blue-600 font-semibold">{formData.email}</span>
              </p>
              ...
              <p className="text-center text-xs text-slate-400 mt-6">
                Didn't receive code? <span className="text-blue-600 font-bold cursor-pointer">Resend OTP</span>
              </p>
            </div>
          )}
